...
public class AdCategoryController {
	...
	private final AdCategoryService adCategoryService;
	   ...
	   @ResponseBody
	   @GetMapping("/twoCategory/{cg_parent_code}")
	   public ResponseEntity<List<CategoryVO>> twoCategory(@PathVariable("cg_parent_code") Integer cgt_parent_code) throws Exception {

  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>  
        ...
        <td><span class ="unitTotalprice" id="unitTotalprice">${(cartDTO.prod_price  * cartDTO.cart_amount)}</span></td>
      </tr>
      </c:forEach>
    </tbody>
    <tfoot>
      ...
      <div class="form-group row" id="nobank_info" style="display: none;">
        ...
        <div class="col-10">
          ...
          <select name="pay_nobank" id="pay_nobank">
            <option value="123-123-1234">KEB & 하나은행</option>
            <option value="456-456-4567">국민은행</option>
            <option value="100-100-1000">신한은행</option>
            <option value="200-200-2000">농협</option>
          </select><br>

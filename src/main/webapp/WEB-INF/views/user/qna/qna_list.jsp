...
<script id="reviewTemplate" type="text/x-handlebars-template">
  <table class="table table-sm">
     ...
     <tbody>
        {{#each .}}
        <tr>
           <th scope="row" class="qa_num">{{qna_list.qa_num}}</th>
           <td class="qa_content">{{qna_list.qa_content}}</td>
           <td class="mbsp_id">{${loginStatus.mbsp_id}}</td>
           <td class="qa_regdate">{{qna_list.qa_regdate}}</td>
           <td>
        </tr>
        {{/each}}
     </tbody>
...
<div class="container">
  <di class="card-deck mb-3 text-center row">
    <di class="col-md-6">
      ...
      <div class="row text-left">
        <div class="col">
          글제목 : <span id="unit_price"></span>
        </div>
      </div>
      <div class="row text-left">
        <div class="col">
        글내용 <input type="text"  value="${loginStatus.mbsp_id}">
        </div>
      </div>
      <div class="row text-left">
        <div class="col">
          작성일: <span id="tot_price"></span>
        </div>
      </div>
      </div>
      </div>
        ...
        <div id="tabs-proreview">
          ...
          <div class="row">
            <div class="col-md-12 text-right">
              <button type="button" id="btn_review_write" class="btn btn-primary" >상품후기작성</button>
            </div>
            </div>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btn_review_save" class="btn btn-primary" >상품후기저장</button>
